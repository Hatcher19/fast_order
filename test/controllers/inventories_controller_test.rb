...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { count_in: @inventory.count_in, count_out: @inventory.count_out, sku: @inventory.sku } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { count_in: @inventory.count_in, count_out: @inventory.count_out, sku: @inventory.sku } }
