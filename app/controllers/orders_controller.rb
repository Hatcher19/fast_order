class OrdersController < ApplicationController
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:status, :date, :entity, :user_id, :address_id, :tracking, :ship_vendor, :spreadsheet_link, line_items_attributes: [:id, :league, :team, :division, :shirtcolor, :inkcolor, :shirtsize, :shirt_quantity, :order_id])
    end
end